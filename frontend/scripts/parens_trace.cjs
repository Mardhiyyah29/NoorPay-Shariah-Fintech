...
for(let i=0;i<lines.length;i++){
  ...
  if(i%50===0) console.log('line',i+1,'cum',cum);
  if(cum<0){ console.log('Negative at line',i+1,'cum',cum); console.log(lines.slice(Math.max(0,i-3),i+1).join('\n')); break; }
}
console.log('done cum',cum);
